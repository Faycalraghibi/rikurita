...
def _reorder_by_priority(items: list, priority_names: list, name_key: str = "name") -> list:
...
"""
    ...
    contact_parts = []
    if email:
        contact_parts.append(r"\href{mailto:" + email + r"}{" + escape_latex(email) + r"}")
    if phone:
    ...
    if linkedin:
        ...
        contact_parts.append(r"\href{" + linkedin_url + r"}{" + escape_latex(linkedin_display) + r"}")
    if github:
        github_url = github if github.startswith("http") else f"https://{github}"
        github_display = github.replace("https://", "").replace("www.", "")
        contact_parts.append(r"\href{" + github_url + r"}{" + escape_latex(github_display) + r"}")
    ...
    if education:
        ...
        for edu in education:
            ...
            latex += r"\resumeSubheading{" + institution + r"}{" + dates + r"}{" + degree + r"}{" + loc + r"}" + "\n"
    ...
    if experience:
        ...
        for exp in experience:
            ...
            latex += r"\resumeSubheading{" + company + r"}{" + dates + r"}{" + role + r"}{" + loc + r"}" + "\n"
    ...
    if skills:
        ...
        if prog_langs:
            langs = ", ".join(escape_latex(l) for l in prog_langs)
        ...
        if languages:
            ...
            for lang in languages:
                if isinstance(lang, dict):
                    ...
                    if lname:
                        lang_parts.append(f"{escape_latex(lname)} ({escape_latex(level)})" if level else escape_latex(lname))
                else:
    ...
    if extracurricular:
        ...
        for activity in extracurricular[:3]:
            ...
            latex += r"\resumeProject{" + role + " -- " + org + r"}{" + dates + r"}" + "\n"
